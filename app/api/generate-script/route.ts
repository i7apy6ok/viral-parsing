...
Важно: sentences используются для TTS-озвучки по чанкам, поэтому не склеивай предложения вместе.`;
  ...
  const longWarning = isLong
    ? `КРИТИЧЕСКИ ВАЖНО: Целевая длина — примерно ${targetMin} минут, около ${finalWords} слов живой речи.
Пиши подробно и естественно, как опытный рассказчик — уникальный авторский материал, не дословный пересказ.\n\n`
    : "";
