...
Разбей ВСЁ содержимое body на отдельные предложения — каждый элемент ровно одно предложение.
Количество предложений должно соответствовать длине сценария естественным образом — не сокращай и не растягивай искусственно.`
